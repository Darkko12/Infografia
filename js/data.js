window.APP_DATA = {
  n1: {
    ...
    openaiPeople: [
      { name:'Sam Altman', role:'Referente de OpenAI', image:'assets/referentes/sam-altman.jpg', facts:['Texto 1 pendiente de la exportación final.','Texto 2 pendiente de la exportación final.','Texto 3 pendiente de la exportación final.'] },
      { name:'Greg Brockman', role:'Referente de OpenAI', image:'assets/referentes/greg-brockman.jpg', facts:['Texto 1 pendiente de la exportación final.','Texto 2 pendiente de la exportación final.','Texto 3 pendiente de la exportación final.'] },
      { name:'Ilya Sutskever', role:'Referente histórico de OpenAI', image:'assets/referentes/ilya-sutskever.jpg', facts:['Texto 1 pendiente de la exportación final.','Texto 2 pendiente de la exportación final.','Texto 3 pendiente de la exportación final.'] }
    ],
    competitors: {
